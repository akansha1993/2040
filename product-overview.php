...
$sql=$GFH_Admin->getproduct($_GET['product']);
						...
						<div class="flexslider">
							<ul class="slides">
							  ...
							  foreach($img as $prodimg) {?>
								<li data-thumb="<?php echo url('images/product/'.$prodimg);?>">
									<div class="thumb-image <?php if($i==1){ echo 'detail_images'; }?> "> <img src="<?php echo url('images/product/'.$prodimg);?>" data-imagezoom="true" alt=""> </div>
								</li>
								<?php } ?>
