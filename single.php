				...
				<div class="single-page-row" id="detail-21">
						...
						<div class="flexslider">
							<ul class="slides">
								<li data-thumb="assets/images/product1.jpg">
									<div class="thumb-image detail_images"> <img src="assets/images/product1.jpg" data-imagezoom="true" alt=""> </div>
								</li>
								<li data-thumb="assets/images/product2.jpg">
									 <div class="thumb-image"> <img src="assets/images/product2.jpg" data-imagezoom="true" alt=""> </div>
								</li>
								<li data-thumb="assets/images/product3.jpg">
								   <div class="thumb-image"> <img src="assets/images/product3.jpg" data-imagezoom="true" alt=""> </div>
								</li> 
							</ul>
						</div>
					</div>
					...
					<div class="col-md-6 single-top-right">
						<div class="product-spec">
							...
							<p style="color:#00796B;">Extra &nbsp;<i class="fa fa-inr" aria-hidden="true">3468</i> discount</p>
							<div class="pp">
								<a href=""><i class="fa fa-inr" aria-hidden="true">26,032</i></a>
							</div>

								<h5 style="padding-left: 100px;margin-top: -20px;">
							
									<i class="fa fa-inr" aria-hidden="true" style="text-decoration: line-through;">2500</i>&nbsp;&nbsp;&nbsp;11% off
							</h5><br>

							<div class="single-detail">
								<ul>
									<li><a href=""><i class="fa fa-picture-o" aria-hidden="true" style="color: #00796B;font-size: 17px;"></i>&nbsp;&nbsp;&nbsp;&nbsp;<b>No cost EMI</b>.Other EMI from
									</a></li><br>

									<li><a href=""><i class="fa fa-arrow-circle-o-right" aria-hidden="true" style="color: #00796B;font-size: 17px;"></i>&nbsp;&nbsp;&nbsp;&nbsp; No cost EMI</a></li><br>

									<li><a href=""><i class="fa fa-tag" aria-hidden="true" style="color: #00796B;font-size: 17px;"></i>&nbsp;&nbsp;&nbsp;&nbsp; No cost EMI</a></li><br>
							...
							<div class="single-des">
								<h2 style="color: #000;">Specifications</h2><br><br>
								<div class="des-box">
									<h5 style="color: #000;">General</h5><br>
									<div class="row">
										<div class="col-md-3">
											<h6>In The Box</h6><br>
											<h6>Model No</h6><br>
										...
										<div class="col-md-9">
											<p>Charger,Headset,Quick Start Guide</p>
											<p>E-2334</p>
											<p>Charger</p>
										</div>
									</div>
