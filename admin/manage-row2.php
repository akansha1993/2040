...
<?php if(isset($_POST['status'])){
    $GFH_Admin->row2(isset($_GET['q'])?$_GET['q']:'');
}
if(isset($_GET['delete']))
{
    $GFH_Admin->deleterow2($_GET['delete']);
}?>
    <!-- BEGIN CONTENT-->
    <div id="content">
        <section>
                        ...
                        <div class="card card-underline">
                            <div class="card-head">
                                <ul class="nav nav-tabs pull-right" data-toggle="tabs">
                                    <li class=" <?php if(empty($_GET['q'])){ echo 'active';}?>"><a href="#first2">Row2</a></li>
                                    <li class="<?php if(!empty($_GET['q'])){ echo 'active';}?>"><a href="#second2"><?php if(empty($_GET['q'])){ echo'Add Product Row2';} else{echo'Edit ProductRow2';}?> </a></li>

                                </ul>
                                <header><?php if(empty($_GET['q'])){ echo'Add Product Row2';} else{echo'Edit Product Row2';}?> </header>
                            </div>
                                    ...
                                    <div class="table-responsive">
                                       ...
                                       while( $na=mysqli_fetch_array($sql)){?>
                                        <tr class="gradeX">
                                            ...
                                            <td><img style="width:50px;" src="../images/row2/<?php echo $na['image'];?>"></td>
                                            ...
                                            <td>
                                                <div class="btn-group">
                                                    ...
                                                    <ul class="dropdown-menu no-padding" role="menu">
                                                        <li><a href="<?php $_SERVER['PHP_SELF'];?>?q=<?php echo $na['row2_id'];?>" class="btn  ink-reaction btn-flat btn-warning"><i class="fa fa-edit"></i> Edit
                                                            </a></li>
                                                        <li class="divider"></li>
                                                        <li><a href="<?php $_SERVER['PHP_SELF'];?>?delete=<?php echo $na['row2_id'];?>" class="btn  ink-reaction btn-flat btn-danger"><i class="fa fa-remove"> </i> Delete
                                                            </a></li>
