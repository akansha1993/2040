...
<div id="base">
    ...
    <!--end .offcanvas-->
    <!-- END OFFCANVAS LEFT -->
<?php if(isset($_POST['question']) && !empty($_POST['ans'])){
    $GFH_Admin->Faq(isset($_GET['q'])?$_GET['q']:'');
}
if(isset($_GET['delete']))
{
    $GFH_Admin->deletefaq($_GET['delete']);
}?>
    <!-- BEGIN CONTENT-->
    <div id="content">
        <section>
                        ...
                        <div class="card card-underline">
                            <div class="card-head">
                                <ul class="nav nav-tabs pull-right" data-toggle="tabs">
                                    <li class=" <?php if(empty($_GET['q'])){ echo 'active';}?>"><a href="#first2">FAQ</a></li>
                                    <li class="<?php if(!empty($_GET['q'])){ echo 'active';}?>"><a href="#second2"><?php if(empty($_GET['q'])){ echo'Add FAQ';} else{echo'Edit FAQ';}?> </a></li>

                                </ul>
                                <header><?php if(empty($_GET['q'])){ echo'FAQ';} else{echo'Edit FAQ';}?> </header>
                            </div>
                                ...
                                <div class="tab-pane <?php if(empty($_GET['q'])){ echo 'active';}?>" id="first2">
                                    <div class="table-responsive">
                                       ...
                                       while( $na=mysqli_fetch_array($sql)){?>
                                        <tr class="gradeX">
                                            <td><?php echo $i;?></td>
                                            <td><?php echo $na['question'];?></td> 
                                            <td><?php echo $na['created_on'];?></td> 
                                            <td>
                                                <div class="btn-group">
                                ...
                                <div class="tab-pane <?php if(!empty($_GET['q'])){ echo 'active';}?>" id="second2">
                                    <form method="post" class="form form-validate floating-label" enctype="multipart/form-data">
                                        <?php if(isset($_GET['q'])){
                                            ...
                                            $naa=$GFH_Admin->FaqbyId($_GET['q']);
                                        }?>
                                        <div class="row">
                                       <div class="col-md-7">
                                           <div class="form-group">
                                               <input type="text" class="form-control" id="Email1" value="<?php echo isset($naa['question'])?$naa['question']:'';?>" name="question"
                                                      required="" aria-required="true">
                                               <label for="Email1">Question</label>
                                           </div>
  ...
  <div class="col-md-12">
                                                <div class="form-group">
                                                    <h4>Answer</h4>
                                                      <textarea name="ans" class="form-control control-12-rows summernote"
                                                                  placeholder="Enter text ..."><?php echo isset($naa['ans'])?$naa['ans']:''?></textarea>
