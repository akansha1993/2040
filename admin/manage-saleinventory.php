                            ...
                            <div class="card-body tab-content">
                                <div class="tab-pane active" id="first2">
                                    ...
                                    <div class="table-responsive">
                                        ...
                                        <tbody>
                                        <?php $i=1;
                                        $sql1= $GFH_Admin->getsaleinventory(isset($_GET['start'])?date("Y-m-d",strtotime($_GET['start'])):'',isset($_GET['end'])?date("Y-m-d",strtotime($_GET['end'])):'');
