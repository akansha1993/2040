...
<?php if(isset($_POST['name'])){
    $GFH_Admin->subCategory(isset($_GET['q'])?$_GET['q']:'');
}
if(isset($_GET['delete']))
{
    $GFH_Admin->deletesubCategory($_GET['delete']);
}?>
    <!-- BEGIN CONTENT-->
    <div id="content">
        <section>
                        ...
                        <div class="card card-underline">
                            <div class="card-head">
                                <ul class="nav nav-tabs pull-right" data-toggle="tabs">
                                    ...
                                    <li class="<?php if(!empty($_GET['q'])){ echo 'active';}?>"><a href="#second2"><?php if(empty($_GET['q'])){ echo'Add Sub Category';} else{echo'Edit Sub Category';}?> </a></li>

                                </ul>
                                <header><?php if(empty($_GET['q'])){ echo'Sub Category';} else{echo'Edit Sub Category';}?> </header>
                            </div>
                            <div class="card-body tab-content">
                                <div class="tab-pane <?php if(empty($_GET['q'])){ echo 'active';}?>" id="first2">
                                    <div class="table-responsive">
                                        ...
                                        <tbody>
                                        <?php $i=1;
                                        $sq= $GFH_Admin->getsubCategory();
                                       while( $na=mysqli_fetch_array($sq)){?>
                                        <tr class="gradeX">
                                            <td><?php echo $i;?></td>
                                            <td><?php echo $na['subcategory_name'];?></td>
                                            <td><?php $sql=$GFH_Admin->getCategory($na['fk_category_id']);
                                            $gh=mysqli_fetch_array($sql); echo $gh['category_name'];?></td>
                                            <td><?php if($na['status']=='1'){echo 'Active';}else{
                                            echo "Inactive";
                                                }?></td>
                                            
                                            <td><img style="width:50px;" src="../images/category/<?php echo $na['image'];?>"></td>
                                ...
                                <div class="tab-pane <?php if(!empty($_GET['q'])){ echo 'active';}?>" id="second2">
                                    <form method="post" class="form form-validate floating-label" enctype="multipart/form-data">
                                        <?php if(isset($_GET['q'])){
                                            $sl=$GFH_Admin->getsubCategory($_GET['q']);
                                       ...
                                       <div class="col-md-7">
                                           ...
                                           <div class="col-md-3">
                                               ...
                                               <div class="col-md-4">
                                                   <div class="form-group">
                                                       <select id="select1" name="category_id" class="form-control" required=""
                                                               aria-required="true">
                                                           <?php $slk=$GFH_Admin->getCategory(); while($cat=mysqli_fetch_array($slk)){?>
