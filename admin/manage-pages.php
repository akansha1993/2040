...
if(isset($_GET['delete']))
{
                        ...
                        <div class="card card-underline">
                            <div class="card-head">
                                <ul class="nav nav-tabs pull-right" data-toggle="tabs">
                                    <li class=" <?php if(empty($_GET['q'])){ echo 'active';}?>"><a href="#first2">Pages</a></li>
                                    <li class="<?php if(!empty($_GET['q'])){ echo 'active';}?>"><a href="#second2"><?php if(empty($_GET['q'])){ echo'Add Pages';} else{echo'Edit Pages';}?> </a></li>

                                </ul>
                                <header><?php if(empty($_GET['q'])){ echo'Pages';} else{echo'Edit Pages';}?> </header>
                            </div>
                                ...
                                <div class="tab-pane <?php if(empty($_GET['q'])){ echo 'active';}?>" id="first2">
                                    <div class="table-responsive">
                                       ...
                                       while( $na=mysqli_fetch_array($sql)){?>
                                        <tr class="gradeX">
                                            <td><?php echo $i;?></td>
                                            <td><?php echo $na['page_name'];?></td>
                                             <td><?php echo $na['title'];?></td>
                                            <td><?php echo $na['created_date'];?></td> 
                                            <td>
                                                <div class="btn-group">
                                                    ...
                                                    <ul class="dropdown-menu no-padding" role="menu">
                                                        <li><a href="<?php $_SERVER['PHP_SELF'];?>?q=<?php echo $na['page_id'];?>" class="btn  ink-reaction btn-flat btn-warning"><i class="fa fa-edit"></i> Edit
                                                            </a></li>
                                                        <li class="divider"></li>
                                                        <li><a href="<?php $_SERVER['PHP_SELF'];?>?delete=<?php echo $na['page_id'];?>" class="btn  ink-reaction btn-flat btn-danger"><i class="fa fa-remove"> </i> Delete
                                                            </a></li>
                                ...
                                <div class="tab-pane <?php if(!empty($_GET['q'])){ echo 'active';}?>" id="second2">
                                    <form method="post" class="form form-validate floating-label" enctype="multipart/form-data">
                                        <?php if(isset($_GET['q'])){
                                            ...
                                            $naa=$GFH_Admin->PagesByID($_GET['q']);
                                        }?>
                                        <div class="row">
                                       <div class="col-md-7">
                                           <div class="form-group">
                                               <input type="text" class="form-control" id="Email1" value="<?php echo isset($naa['title'])?$naa['title']:'';?>" name="title"
                                                      required="" aria-required="true">
                                               <label for="Email1">Page Title</label>
                                           </div>
                                           <div class="row">
                                           <div class="col-md-6">
                                               <div class="form-group">
                                                   <select id="select1" name="page_name" class="form-control" required=""
                                                           aria-required="true">
  ...
  <div class="col-md-12">
                                                <div class="form-group">
                                                    <h4>Pages Body</h4>
                                                      <textarea name="description" class="form-control control-12-rows summernote"
