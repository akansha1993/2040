                                                ...
                                                <div class="form-group floating-label">
                                                    <select id="subcategory_id" name="subcategory_id" class="form-control" required="" aria-required="true">
                                                        <?php if(!empty($naa['subcategory_id'])){
                                                            $subca=$GFH_Admin->getsubCategory(isset($naa['subcategory_id']));
                                                            $subcat=mysqli_fetch_array($subca);
                                                            echo '   <option value="'.$subcat["subcategory_id"].'">'.$subcat["subcategory_name"].'</option>';
                                                        }?>
                                                    </select>
