...
<?php if(isset($_POST['status'])){
    $GFH_Admin->banner(isset($_GET['q'])?$_GET['q']:'');
}
if(isset($_GET['delete']))
{
    $GFH_Admin->deletebanner($_GET['delete']);
}?>
    <!-- BEGIN CONTENT-->
    <div id="content">
        <section>
                        ...
                        <div class="card card-underline">
                            <div class="card-head">
                                <ul class="nav nav-tabs pull-right" data-toggle="tabs">
                                    <li class=" <?php if(empty($_GET['q'])){ echo 'active';}?>"><a href="#first2">Banners</a></li>
                                    <li class="<?php if(!empty($_GET['q'])){ echo 'active';}?>"><a href="#second2"><?php if(empty($_GET['q'])){ echo'Add Banner';} else{echo'Edit Banner';}?> </a></li>

                                </ul>
                                <header><?php if(empty($_GET['q'])){ echo'Add Banner';} else{echo'Edit Banner';}?> </header>
                            </div>
                                    ...
                                    <div class="table-responsive">
                                       ...
                                       while( $na=mysqli_fetch_array($sql)){?>
                                        <tr class="gradeX">
                                            ...
                                            <td><img style="width:50px;" src="../images/banner/<?php echo $na['image'];?>"></td>
