...
<?php if(isset($_POST['name'])){
    $GFH_Admin->offerbanner(isset($_GET['q'])?$_GET['q']:'');
}
if(isset($_GET['delete']))
{
    $GFH_Admin->deleteofferbanner($_GET['delete']);
}?>
    <!-- BEGIN CONTENT-->
    <div id="content">
        <section>
                        ...
                        <div class="card card-underline">
                            <div class="card-head">
                                <ul class="nav nav-tabs pull-right" data-toggle="tabs">
                                    <li class=" <?php if(empty($_GET['q'])){ echo 'active';}?>"><a href="#first2">Offer's Banners</a></li>
                                    <li class="<?php if(!empty($_GET['q'])){ echo 'active';}?>"><a href="#second2"><?php if(empty($_GET['q'])){ echo'Add Offer\'s Banner';} else{echo'Edit Offer\'s Banner';}?> </a></li>

                                </ul>
                                <header><?php if(empty($_GET['q'])){ echo'Add Offer\'s Banner';} else{echo'Edit Offer\'s Banner';}?> </header>
                            </div>
                            <div class="card-body tab-content">
                                    ...
                                    <div class="table-responsive">
                                       ...
                                       while( $na=mysqli_fetch_array($sql)){?>
                                        <tr class="gradeX">
                                            ...
                                            <td><img style="width:50px;" src="../images/offer-banner/<?php echo $na['image'];?>"></td>
                                            ...
                                            <td>
                                                <div class="btn-group">
                                                    ...
                                                    <ul class="dropdown-menu no-padding" role="menu">
                                                        <li><a href="<?php $_SERVER['PHP_SELF'];?>?q=<?php echo $na['banner_id'];?>" class="btn  ink-reaction btn-flat btn-warning"><i class="fa fa-edit"></i> Edit
                                                            </a></li>
                                                        <li class="divider"></li>
                                                        <li><a href="<?php $_SERVER['PHP_SELF'];?>?delete=<?php echo $na['banner_id'];?>" class="btn  ink-reaction btn-flat btn-danger"><i class="fa fa-remove"> </i> Delete
                                                            </a></li>
                                ...
                                <div class="tab-pane <?php if(!empty($_GET['q'])){ echo 'active';}?>" id="second2">
                                    <form method="post" class="form form-validate floating-label" enctype="multipart/form-data">
                                        <?php if(isset($_GET['q'])){
                                            $sl=$GFH_Admin->getofferbanner($_GET['q']);
