				...
				<div class="header-search">
				 <form action="#" method="get">
						...
						<button type="submit" class="btn btn-default" aria-label="Left Align">
                            ...
                            <ul class="" id="search_result"style="max-height: 250px;width: 625px !important;position: absolute;background-color: white;/* width: auto; */overflow-x: visible;overflow-y: scroll;height: auto;margin: 0px 0px 0px 0px;list-style: none;text-align: left;">
